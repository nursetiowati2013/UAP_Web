...
<div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <h2 class="mb-4"><b>Sistem Informasi Administrasi Kependudukan</b></h2>
        <h4>Selamat datang di dashboard Sistem Informasi Administrasi Kependudukan, Dashboard ini bisa digunakan untuk mengedit informasi dan persyaratan serta bisa juga digunakan untuk melihat isi form pengaduan yang dikirim oleh user.</h4>
      </div>
		</div>
