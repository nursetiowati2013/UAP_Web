...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #b16c63;">
        ...
        <div class="container-fluid py-5 bg-white text-black ">
            <div class="container">
                <h2 class="text-center mb-4">Akta Kematian</h2>
                <div class="offset-lg-2 col-lg-8">
                    <form action="" method="post">
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label for="nama" class="form-label">No. Akta Kematian</label>
                                    <input type="text" name="no_akta_kematian" class="form-control" autocomplete="off">
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label for="nama" class="form-label">Tempat Wafat</label>
                                    <input type="text" name="tempat_wafat" class="form-control" autocomplete="off">
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-lg-6">
                                    <label for="nama" class="form-label">Tanggal Wafat</label>
                                    <input type="text" name="tanggal_wafat" class="form-control" autocomplete="off">
                                    <label class="form-text">*contoh : 25/03 -> (25 Maret)</label>
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="col-lg-6">
                                <label for="nama" class="form-label">Tahun Wafat</label>
                                <input type="text" name="tahun_wafat" class="form-control" autocomplete="off">
                            </div>
                        </div>
                    ...
                    <?php
                        ...
                        if(isset($_POST['kirim'])){
                            mysqli_query($koneksi, "insert into akta_kematian set
                                no_akta_kematian =  '$_POST[no_akta_kematian]',
                                ...
                                window.location='kematian.php';</script>";
                        }
